...
public class IslamicBooks {
    ...
    private static JScrollPane createContentPanel(final JFrame frame) {
        ...
        List<Book> sample = Arrays.asList(
            new Book("Aquidat El Tawhid", "Dr. Saleh El fawzan", "1200 DA", "islamic/Aquidat_Tawhid.jpg"),
            new Book("Oumdat El Tafsir", "Imam Ibn Kathir", "6700DA", "islamic/Oumdat_El_Tafsir.jpg"),
            new Book("El Rahique El Makhtoum", "Imam Moubarkfouri", "2500 DA", "islamic/Rahique_Makhtoum.jpg"),
            new Book("Sahih El Boukhari", "Imame Boukhari", "8000 DA", "islamic/Boukhari.jpg"),
            new Book("Tadim El Salat", "Dr.Abd El Razeque El Badr", "1500 DA", "islamic/Tadim_Salat.jpg"),
            new Book("Moulakhas El Feqhi", "Dr. Saleh El fawzan", "3000 DA", "islamic/El_Moulakhas_El_Fequhi.jpg")
        );
